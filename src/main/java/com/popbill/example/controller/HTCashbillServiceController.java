/**
  * 팝빌 홈택스 현금영수증 API Java SDK SpringBoot Example
  *
  * SpringBoot 연동 튜토리얼 안내 : https://developers.popbill.com/guide/htcashbill/java/getting-started/tutorial?fwn=springboot
